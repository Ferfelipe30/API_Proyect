...
class Persona(models.Model):
    ...
    email = models.EmailField(max_length=100, db_column='T001Email')
...
class Tarea(models.Model):
    ...
    titulo = models.CharField(max_length=100, db_column='T002Titulo')
    descripcion = models.TextField(db_column='T002Descripcion')
    fecha_limite = models.DateField(db_column='T002FechaLimite')
    persona = models.ForeignKey(Persona, on_delete=models.CASCADE, related_name='tareas', db_column='T002IdPersona')
